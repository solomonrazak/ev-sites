  ...
  return (
    <div className="w-full h-full flex flex-col xl:flex-row gap-5">
      <div className="w-full xl:w-[65%]">
          ...
          <div className="flex gap-3 items-center">
            ...
            <>
              {isValueVisible ? (
                ...
                <FaEyeSlash onClick={toggleVisibility} className="text-[27px]"/>
              )}
            </>
          </div>
        </div>
        ...
        <Input label="Phone Number" placeholder="000000000" type="text" className="bg-black w-full"/>
        <Input label="Set Amount (₵); How much would you like to pay up to" placeholder="100" type="text" className="bg-black w-full"/>
        <button className="bg-blue-700 w-16 px-1 py-1 rounded-[5px] justify-end text-[17px] ml-auto">Top Up</button>
        </form>
        </div>
      </div>
